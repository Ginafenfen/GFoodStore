...
const ViewTotal = () => {
  ...
  const fetchData = async () => {
    ...
    reactCtx.setCarts(data);
    alert(reactCtx.carts);
  };
  ...
  //     .then((result) => reactCtx.setCart(result))
  //     .catch((error) => console.log("error", error));
  //   console.log(reactCtx.cart);
  // };
